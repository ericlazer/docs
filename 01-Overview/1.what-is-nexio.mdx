...
| Generic, one-size-fits-all lending            | Borrower-specific Series with defined strategy, term, collateral tier, and covenants. One borrower, one vault, one set of fixed terms.                                                   |
