...
Each borrower is bound by a customized set of covenants based on its Series term sheet, credit score, and strategy type. Nexio’s Risk and Governance Committee approves all parameters before activation.
