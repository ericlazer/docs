...
The tier determines borrowing limits, reporting cadence, and eligible strategies. For example, a Tier 1 firm posting \$11 million in collateral might borrow \$10 million in BTC, while a Tier 3 borrower with the same collateral receives a smaller allowance due to higher risk and stricter limits.
