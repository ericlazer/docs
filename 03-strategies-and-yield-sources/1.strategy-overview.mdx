...
For now, it's simply worth noting that each approach is market-neutral, meaning returns are generated from structural inefficiencies (like price spreads or funding differentials), not speculative bets on BTC’s direction. They therefore enable consistent, transparent yield which makes them suitable for fixed-rate BTC credit.
