...
These users deposit BTC into Series or the Master Vault to earn fixed-rate, BTC-denominated returns. Borrowers (KYC/KYB-verified trading desks, market makers, or hedge funds) operate with assigned credit scores and can only draw from the Series tied to their own Taproot vault.
...
<img
  src="/images/Capturadepantalla2026-01-21ala(s)2.18.18p.m..png"
  alt="5thgraphic Jp"
  style={{ width:"89%" }}
  title=""
/>
