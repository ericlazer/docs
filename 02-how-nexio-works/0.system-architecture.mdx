...
2. **Operations Layer:** The onboarding, facility coordination, servicing, monitoring, and reporting workflows that run the lending business.
...
Together, these layers let lenders allocate BTC to defined borrower opportunities while Nexio manages operational controls and repayment tracking.
...
The Operations Layer is the core of the platform. It is where Nexio coordinates and services each lending facility.
...
- **Onboarding and diligence coordination:** Nexio completes KYC/KYB, compliance checks, and the onboarding steps required before a facility is opened.
...
This is also the layer where Nexio applies concentration limits, covenant monitoring, and operational controls. In practice, lender protection comes from legal agreements, counterparty diligence, facility-specific covenants, monitoring, recovery rights, custody workflows, reporting, and operational controls across the life of the facility.
...
The Custody Layer does not replace counterparty diligence or legal review, but it provides the operational backbone that makes funding, repayment, and recordkeeping reliable.
