...
A registered compliance handler then submits a cryptographic attestation confirming all checks have passed. Only after this attestation is validated does the Operator Queue release the Bitcoin transaction.